    ...
    <div class="container">
        <div class="row">
            <div class="col-md-12">
                ...
                <p>Welcome to Techno Apogee!</p>

                <p>These terms and conditions outline the rules and regulations for the use of Techno Apogee's Website,
                    located at https://technoapogee.com.</p>

                <p>By accessing this website we assume you accept these terms and conditions. Do not continue to use Techno
                    Apogee if you do not agree to take all of the terms and conditions stated on this page.</p>
                ...
                <p>The following terminology applies to these Terms and Conditions, Privacy Statement and Disclaimer Notice
                    ...
                    prevailing law of bd. Any use of the above terminology or other words in the singular, plural,
                    capitalization and/or he/she or they, are taken as interchangeable and therefore as referring to same.
                </p>

                <h3><strong>Cookies</strong></h3>

                <p>We employ the use of cookies. By accessing Techno Apogee, you agreed to use cookies in agreement with the
                    Techno Apogee's Privacy Policy. </p>
                ...
                <p>Unless otherwise stated, Techno Apogee and/or its licensors own the intellectual property rights for all
                    material on Techno Apogee. All intellectual property rights are reserved. You may access this from
                    Techno Apogee for your own personal use subjected to restrictions set in these terms and conditions.</p>

                <p>You must not:</p>
                <ul>
                    <li>Republish material from Techno Apogee</li>
                    <li>Sell, rent or sub-license material from Techno Apogee</li>
                    <li>Reproduce, duplicate or copy material from Techno Apogee</li>
                    <li>Redistribute content from Techno Apogee</li>
                </ul>

                <p>This Agreement shall begin on the date hereof.</p>

                <p>Parts of this website offer an opportunity for users to post and exchange opinions and information in
                    certain areas of the website. Techno Apogee does not filter, edit, publish or review Comments prior to
                    their presence on the website. Comments do not reflect the views and opinions of Techno Apogee,its
                    agents and/or affiliates. Comments reflect the views and opinions of the person who post their views and
                    opinions. To the extent permitted by applicable laws, Techno Apogee shall not be liable for the Comments
                ...
                <p>Techno Apogee reserves the right to monitor all Comments and to remove any Comments which can be
                ...
                <p>You hereby grant Techno Apogee a non-exclusive license to use, reproduce, edit and authorize others to
                ...
                <p>We will approve link requests from these organizations if we decide that: (a) the link would not make us
                    ...
                    absence of Techno Apogee; and (d) the link is in the context of general resource information.</p>
                ...
                <p>If you are one of the organizations listed in paragraph 2 above and are interested in linking to our
                    website, you must inform us by sending an e-mail to Techno Apogee. Please include your name, your
                ...
                <p>No use of Techno Apogee's logo or other artwork will be allowed for linking absent a trademark license
                    agreement.</p>
